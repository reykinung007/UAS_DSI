...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2023 at 05:54 AM
...
(3, 34, 2, 1, 90000, 'Ikat', 1057, 1661772411, 2, 0, 0, 0, 0),
(4, 35, 2, 1, 120000, 'Ikat', 1057, 1661772418, 2, 0, 0, 0, 0);
...
CREATE TABLE `detail_order` (
  `iddetail_order` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
(13, 29, 13, 2, 150000, 'potong', 3000, 1577559263, 2, 0, 0, 0, 0),
(14, 30, 13, 5, 120000, 'Ikat', 112, 1577559263, 2, 0, 0, 0, 0),
(15, 29, 14, 3, 150000, 'potong', 3000, 1577559936, 7, 0, 0, 0, 0),
(16, 30, 14, 1, 120000, 'Ikat', 112, 1577559936, 7, 0, 0, 0, 0),
(17, 31, 14, 1, 120000, 'Ikat', 1057, 1577559936, 7, 0, 0, 0, 0),
(18, 30, 15, 2, 120000, 'Ikat', 112, 1578159845, 2, 0, 0, 0, 0),
(19, 29, 15, 3, 150000, 'potong', 3000, 1578159845, 2, 0, 0, 0, 0),
(20, 37, 15, 1, 120000, 'Ikat', 1057, 1578159845, 2, 0, 0, 0, 0),
...
CREATE TRIGGER `kurang_stok` AFTER INSERT ON `detail_order` FOR EACH ROW BEGIN
	UPDATE product set product.stok = product.stok-new.qty WHERE product.idproduct = new.product_id;
END
$$
DELIMITER ;
...
(1, '<p>Silahkan lakukan pembayaran ke rekening berikut :</p>\r\n\r\n<p>Pastikan anda mentransfer sesuai jumlah harga pesanan anda</p>\r\n\r\n<p><code>BRI</code></p>\r\n\r\n<p><code>KSU AGROBLITAR</code></p>\r\n\r\n<p><code>00111-111111-111-11-111-1</code></p>\r\n', 1578216906, 1, 1690010890, 1),
(2, '<p>Silahkan lakukan pembayaran ke rekening berikut :</p>\r\n\r\n<p>Pastikan anda mentransfer sesuai total harga pemesanan anda</p>\r\n\r\n<p>BRI</p>\r\n\r\n<p>KSU AGROBINTUNI</p>\r\n\r\n<p>00212-124912-124-24-124-1</p>\r\n', 1578217795, 1, 0, 0);
...
(1, 'JNE', 'Jalur Nugraha Ekakurir (JNE)', 'OKE', 'Ongkos Kirim Ekonomis', 1577128687, 1, 0, 0),
(2, 'JNE', 'Jalur Nugraha Ekakurir (JNE)', 'REG', 'Layanan Reguler', 1577128810, 1, 0, 0),
(4, 'JNE', 'Jalur Nugraha Ekakurir (JNE)', 'YES', 'Yakin Esok Sampai', 1577128881, 1, 0, 0),
(5, 'POS', 'Kantor POS', 'Biasa', 'Layanan Biasa', 1577130524, 1, 0, 0);
...
CREATE TABLE `ongkir` (
  ...
  `kode_pos_asal` varchar(15) NOT NULL,
  `tujuan` int(11) NOT NULL,
  `kode_pos_tujuan` varchar(15) NOT NULL,
...
(1, 3471, '55000', 5171, '80000', 'JNE', 'OKE', 38000, '4-5', '', 1577132412, 1, 0, 0),
(2, 3471, '55000', 5171, '80000', 'JNE', 'REG', 44000, '2-3', '', 1577133289, 1, 0, 0),
(3, 3471, '55000', 5171, '80000', 'JNE', 'YES', 98000, '1-1', '', 1577133606, 1, 0, 0);
...
(13, 13, 2, 'bukti-bayar-1577531974.jpg', 1149280, 'verified', 'Sudah saya bayar yah', 1577560774, 1577559263, 2, 1577560875, 1),
(14, 14, 7, 'bukti-bayar-1577532901.jpg', 100000, 'pending', 'asdasd', 1577561701, 1577559936, 7, 0, 0),
(15, 15, 2, '', 0, 'pending', '', 0, 1578159845, 2, 0, 0),
(16, 16, 2, '', 0, 'pending', '', 0, 1661772397, 2, 0, 0);
...
CREATE TABLE `pesanan` (
  ...
  `order_prov` int(11) NOT NULL,
  `order_kab` int(11) NOT NULL,
  `order_kec` varchar(128) NOT NULL,
  `order_kodepos` varchar(15) NOT NULL,
  `order_address` text NOT NULL,
  `order_kurir` varchar(15) NOT NULL,
  `order_layanan` varchar(15) NOT NULL,
  `status_bayar` enum('belum lunas','lunas') NOT NULL,
  `status` enum('pembayaran pending','pembayaran terima','proses','pengiriman','selesai') NOT NULL,
  `create_at` int(11) NOT NULL,
  `create_by` int(11) NOT NULL,
  `update_at` int(11) NOT NULL,
  `update_by` int(11) NOT NULL,
...
(13, 'ODR-1577559263', 'RESI0123456789', 1577559263, 2, 900000, 6560, 249280, 1149280, 51, 5171, 'Manimeri', '98364', 'Jalur 5 SP 1 Kampung Waraitama', 'JNE', 'OKE', 'lunas', 'pengiriman', 1577559263, 2, 1578155742, 1, 0, 0),
(14, 'ODR-1577559936', '', 1577559936, 7, 690000, 10169, 996562, 1686562, 51, 5171, 'Manimeri a', '98363', 'asd', 'JNE', 'YES', 'belum lunas', 'pembayaran pending', 1577559936, 7, 0, 0, 0, 0),
(15, 'ODR-1578159845', '', 1578159845, 2, 810000, 10281, 452364, 1262364, 51, 5171, 'Manimeri', '98364', 'Jalur 5 SP 1 Kampung Waraitama', 'JNE', 'REG', 'belum lunas', 'pembayaran pending', 1578159845, 2, 0, 0, 0, 0),
(16, 'ODR-1661772397', '', 1661772397, 2, 0, 4057, 0, 0, 34, 3404, 'Merdeka', '12345', 'Jl. Pejuang Merdeka Barat', '0', '0', 'belum lunas', 'pembayaran pending', 1661772397, 2, 0, 0, 0, 0);
...
CREATE TABLE `product` (
  ...
  `product_seo` varchar(255) NOT NULL,
...
(30, 29, 'Tomat', 'tomat', 'pcs', 100000, 120000, 0, '112', 'product-1575598058.jpg', '', 2, 1690010150, 1, 1690010150, 1, 0, 0),
(29, 15, 'Brokoli', 'brokoli', 'ikat', 33000, 200000, 50000, '3000', 'product-1575598069.jpg', '', 1, 1690010172, 1, 1690010172, 1, 0, 0),
(27, 29, 'Wortel', 'wortel', 'pcs', 10000, 15000, 2000, '11000', 'product-1575598078.jpg', '', 0, 1690010197, 1, 1690010197, 1, 0, 0),
(31, 15, 'Gubis', 'gubis', 'Ikat', 100000, 120000, 0, '1057', 'product-1689991999.jpeg', '', 0, 1690009999, 1, 1690009999, 1, 0, 0),
(32, 15, 'Kangkung', 'kangkung', 'Ikat', 100000, 120000, 0, '1057', 'product-1689991979.jpeg', '', 1, 1690009979, 1, 1690009979, 1, 0, 0),
(33, 28, 'Stroberi', 'stroberi', 'pcs', 100000, 120000, 0, '1057', 'product-1575598025.jpg', '', 1, 1690010121, 1, 1690010121, 1, 0, 0),
(34, 29, 'Paprika', 'paprika', 'pcs', 100000, 120000, 30000, '1057', 'product-1575598015.jpg', '', 12, 1690010107, 1, 1690010107, 1, 0, 0),
(35, 1, 'Jus', 'jus', 'botol', 100000, 120000, 0, '1057', 'product-1575598112.jpg', '<p>adasd</p>\r\n', 12, 1690010075, 1, 1690010075, 1, 0, 0),
(36, 30, 'Bawang', 'bawang', 'pcs', 100000, 120000, 0, '1057', 'product-1575598140.jpg', '', 12, 1690010063, 1, 1690010063, 1, 0, 0),
(37, 28, 'Apel', 'apel', 'pcs', 100000, 120000, 0, '1057', 'product-1575598172.jpg', '', 11, 1690010052, 1, 1690010052, 1, 0, 0),
(38, 28, 'Jeruk', 'jeruk', 'pcs', 100000, 120500, 500, '1057', 'product-1661753767.png', '', 100, 1690009832, 1, 1690009832, 1, 0, 0),
(39, 28, 'Pisang', 'pisang', 'pcs', 90000, 120500, 2000, '1057', 'product-1661753873.png', '', 499, 1690009807, 1, 1690009807, 1, 0, 0),
(40, 28, 'Persik', 'persik', 'pcs', 100000, 125500, 5500, '1057', 'product-1661753973.png', '', 350, 1690009812, 1, 1690009812, 1, 0, 0),
(41, 28, 'Mangga', 'mangga', 'pcs', 90000, 125500, 2000, '1057', 'product-1689997080.jpeg', '', 350, 1690015080, 1, 0, 0, 0, 0);
...
CREATE TABLE `product_category` (
  ...
  `category_seo` varchar(128) NOT NULL,
...
(1, 'Uncategorized', 'uncategorized', 'Untuk produk-produk yang belum memiliki kategori', 'default.jpg', 2147483647, 0, 1574281566, 1),
(15, 'Sayur Mayur', 'sayur-mayur', 'Berisi tentang sayur mayur', 'category-1661704398.png', 1574245022, 1, 1661722398, 1),
(28, 'Buah-Buahan', 'buah-buahan', 'Berisi tentang buah-buahan', 'category-1661704555.png', 1574374259, 1, 1661722556, 1),
(29, 'Buah Sayur', 'buah-sayur', 'Berisi tentang sayur berbentuk buah', 'category-1661704768.png', 1574374282, 1, 1661722768, 1),
(30, 'Bawang', 'bawang', 'Berisi tentang sejenis bawang', 'category-1661704648.png', 1574946079, 1, 1661722648, 1);
...
(17, 27, 'product_image-1661704969.jpg', 1661722970, 1, 0, 0),
(18, 29, 'product_image-1661704990.jpeg', 1661722990, 1, 0, 0),
(19, 30, 'product_image-1661704999.jpg', 1661722999, 1, 0, 0),
(20, 31, 'product_image-1661705016.jpg', 1661723016, 1, 0, 0),
(21, 32, 'product_image-1661705027.jpg', 1661723027, 1, 0, 0);
...
(1, 'general', 'meta_description', 'Koperasi Serba Usaha Agroblitar', 'Koperasi Serba Usaha Agrobintuni', 'Deskripsi Meta', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(2, 'general', 'meta_keywords', 'Koperasi, KSU, Agro BIitar, Koperasi Blitar, Catalog Agro Blitar', 'Koperasi, KSU, Agrobintuni, Koperasi Bintuni', 'Kata Kunci Meta', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(3, 'general', 'google_map_api_key', 'https://goo.gl/maps/moRLpPYNssVz5byg9', 'AIzaSyDmiycFxzYZ37FOwA4wqSbL3z2YvIYIArw', 'API Key Google Map', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(4, 'general', 'latitude', '-8.127928', '-6.2407311', 'Latitude', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(5, 'general', 'longitude', '112.168313', '106.9972892', 'Longitude', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(6, 'general', 'favicon', 'favicon-1575532386.png', 'favicon.png', 'Favicon', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(7, 'general', 'timezone', 'Asia/Jakarta', 'Asia/Jakarta', 'Time Zone', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(8, 'general', 'file_allowed_types', 'jpg|jpeg|png|gif', 'jpg, jpeg, png, gif', 'Tipe file yang diizinkan', '2018-04-01 18:51:58', '2019-11-03 16:09:29', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(9, 'general', 'upload_max_filesize', '2048', '2000', 'Maksimal Ukuran File yang Diupload', '2018-04-01 18:51:58', '2019-11-02 02:59:58', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(10, 'general', 'city_from_delivery', '3572', '3471', 'Kota Asal Pengiriman', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(18, 'media', 'thumbnail_size_width', NULL, '150', 'Lebar Gambar Thumbnail', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(19, 'media', 'medium_size_height', NULL, '308', 'Tinggi Gambar Sedang', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(20, 'media', 'medium_size_width', NULL, '460', 'Lebar Gambar Sedang', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(21, 'media', 'large_size_height', NULL, '600', 'Tinggi Gambar Besar', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(22, 'media', 'large_size_width', NULL, '800', 'Lebar Gambar Besar', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(23, 'media', 'album_cover_height', NULL, '250', 'Tinggi Cover Album Photo', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(24, 'media', 'album_cover_width', NULL, '400', 'Lebar Cover Album Photo', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(25, 'media', 'banner_height', NULL, '81', 'Tinggi Iklan', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(26, 'media', 'banner_width', NULL, '245', 'Lebar Iklan', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(27, 'media', 'image_slider_height', NULL, '400', 'Tinggi Gambar Slide', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(28, 'media', 'image_slider_width', NULL, '900', 'Lebar Gambar Slide', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(31, 'media', 'employee_photo_height', NULL, '170', 'Tinggi Photo Pegawai', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(32, 'media', 'employee_photo_width', NULL, '113', 'Lebar Photo Pegawai', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(35, 'media', 'header_height', NULL, '80', 'Tinggi Gambar Header', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(36, 'media', 'header_width', NULL, '200', 'Lebar Gambar Header', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(37, 'media', 'logo_height', NULL, '120', 'Tinggi Logo Instansi', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(38, 'media', 'logo_width', NULL, '120', 'Lebar Logo Instansi', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(39, 'writing', 'default_post_category', NULL, '1', 'Default Kategori Tulisan', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(40, 'writing', 'default_post_status', NULL, 'publish', 'Default Status Tulisan', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(41, 'writing', 'default_post_visibility', NULL, 'public', 'Default Akses Tulisan', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(42, 'writing', 'default_post_discussion', NULL, 'open', 'Default Komentar Tulisan', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(43, 'writing', 'post_image_thumbnail_height', NULL, '100', 'Tinggi Gambar Kecil', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(44, 'writing', 'post_image_thumbnail_width', NULL, '150', 'Lebar Gambar Kecil', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(45, 'writing', 'post_image_medium_height', NULL, '250', 'Tinggi Gambar Sedang', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(46, 'writing', 'post_image_medium_width', NULL, '400', 'Lebar Gambar Sedang', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(47, 'writing', 'post_image_large_height', NULL, '450', 'Tinggi Gambar Besar', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(48, 'writing', 'post_image_large_width', NULL, '840', 'Lebar Gambar Besar', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(49, 'reading', 'post_per_page', NULL, '10', 'Tulisan per halaman', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(50, 'reading', 'post_rss_count', NULL, '10', 'Jumlah RSS', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(51, 'reading', 'post_related_count', NULL, '10', 'Jumlah Tulisan Terkait', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(52, 'reading', 'comment_per_page', NULL, '10', 'Komentar per halaman', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(53, 'discussion', 'comment_moderation', NULL, 'false', 'Komentar harus disetujui secara manual', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(54, 'discussion', 'comment_registration', NULL, 'false', 'Pengguna harus terdaftar dan login untuk komentar', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(55, 'discussion', 'comment_blacklist', NULL, 'kampret', 'Komentar disaring', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(56, 'discussion', 'comment_order', NULL, 'asc', 'Urutan Komentar', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(57, 'social_account', 'facebook', 'https://facebook.com', '', 'Facebook', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(58, 'social_account', 'twitter', NULL, '', 'Twitter', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(59, 'social_account', 'google_plus', NULL, '', 'Google Plus', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(60, 'social_account', 'website', 'https://argotani.sejahtra.com', '', 'Website', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(61, 'social_account', 'youtube', 'https://www.youtube.com/', '', 'Youtube', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(62, 'social_account', 'instagram', NULL, '', 'Instagram', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(63, 'mail_server', 'sendgrid_username', NULL, '', 'Sendgrid Username', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(64, 'mail_server', 'sendgrid_password', NULL, '', 'Sendgrid Password', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(65, 'mail_server', 'sendgrid_api_key', NULL, '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', 'Sendgrid API Key', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(67, 'company_profile', 'company_name', 'AGRO BLITAR MART', 'Nokencode', 'Nama Instansi', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(68, 'company_profile', 'headmaster', 'ARGO TANI BLITAR', 'Nokencode', 'Kepala Instansi', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(73, 'company_profile', 'decree_operating_permit', NULL, '-', 'SK Izin Operasional', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(74, 'company_profile', 'decree_operating_permit_date', '2022-08-27', '2018-04-02', 'Tanggal SK Izin Operasional', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(75, 'company_profile', 'tagline', 'Koperasi Serba Usaha Agroblitar', 'Where Tomorrow\'s Leaders Come Together', 'Slogan', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(76, 'company_profile', 'rt', '001', '12', 'RT', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(77, 'company_profile', 'rw', '007', '06', 'RW', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(79, 'company_profile', 'village', 'Klampok', 'Waraitama', 'Kelurahan / Desa', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(80, 'company_profile', 'sub_district', 'Sananwetan', 'Manimeri', 'Kecamatan', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(81, 'company_profile', 'district', 'Blitar', 'Teluk Bintuni', 'Kabupaten', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(82, 'company_profile', 'postal_code', '66136', '98364', 'Kode Pos', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(83, 'company_profile', 'street_address', 'Jl. Flores', 'Jalur 5 SP 1 Kampung Waraitama', 'Alamat Jalan', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(84, 'company_profile', 'phone', '+62 8384 6782 100', '+62 822 4857 7297', 'Telepon', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(85, 'company_profile', 'fax', NULL, '0232123456', 'Fax', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false'),
(86, 'company_profile', 'email', 'argotaniblitar.sejahtera@gmail.com', 'nokencode@gmail.com', 'Email', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(87, 'company_profile', 'website', 'https://argotaniblitar.sejahtra.com', 'https://nokencode.com', 'Website', '2018-04-01 18:51:58', '0000-00-00 00:00:00', NULL, NULL, NULL, 1, NULL, NULL, 'false'),
(88, 'company_profiles', 'logo', '207b44d4186101125969bdb0d0bcbccd.png', 'logo.png', 'Logo', '2018-04-01 18:51:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false');
...
(4, 'slide-1661752372.png', 'We serve Fresh Vegestables & Fruits', 'We deliver organic vegetables & fruits', 1575626076, 1, 1661770372, 1),
(5, 'slide-1661752699.png', '100% Fresh & Organic Foods', 'We deliver organic vegetables & fruits', 1575626155, 1, 1661770699, 1);
...
(2, 2, 'Eka Saputra', '081222333444', 'Programmer', 'Hidup lebih sehat dan bugar berkat kebaikan AgroBlitar. Buah dan sayur segar dari website mereka selalu mengisi meja makan kami setiap hari. Tak hanya rasanya lezat, tetapi kualitasnya juga tak terkalahkan. Terima kasih AgroBlitar!', 'Yes', 1575714719, 2, 1690010477, 1),
(3, 5, 'Muhammad Aziz', 'saputra.bintuni', 'wirasuwasta', 'Satu kata untuk AgroBlitar: Luar Biasa! Selalu dapatkan pelayanan yang ramah dan cepat dari mereka. Buah-buahannya terasa seperti baru dipetik langsung dari kebun. Tak perlu khawatir tentang kualitasnya, karena AgroBlitar selalu memberikan yang terbaik.', 'Yes', 1575715791, 5, 1575715852, 1),
(4, 0, 'tes', 'tes@gmail.com', 'tes', 'Surga buah dan sayur ada di AgroBlitar. Saya sangat senang menemukan situs ini! Pengalaman belanja yang menyenangkan, lengkap dengan buah-buah segar dan sayuran terbaik yang pernah saya temui. Saya benar-benar merekomendasikan AgroBlitar kepada siapa pun yang ingin hidup sehat.', 'Yes', 0, 0, 1690010864, 1),
(5, 4, 'Zahra Amelia', 'coba@gmail.com', 'Perawat', 'AgroBlitar adalah penyelamat! Saya seorang ibu bekerja yang sibuk, dan berbelanja di toko seringkali merepotkan. Tapi dengan AgroBlitar, saya dapat dengan mudah membeli buah dan sayur segar dengan beberapa klik saja. Selain itu, kualitasnya tetap terjaga. Terima kasih AgroBlitar, kini hidup sehat jadi lebih mudah!', 'Yes', 0, 0, 1575716085, 1),
(6, 6, 'Widya Prastika', 'aku@gmail.com', 'Perawat', 'Rasakan kelezatan dari tanah yang subur melalui AgroBlitar. Berbelanja di situs mereka adalah pengalaman yang tiada banding. Selalu ada banyak pilihan buah dan sayur segar yang tersedia, dan semuanya terasa istimewa. Saya tak bisa memuji AgroBlitar cukup banyak!', 'Yes', 1576433102, 6, 1576433133, 1),
(7, 2, 'dwibakti', '108341801844', 'Pelajar', 'AgroBlitar membuat hidup kami lebih berwarna! Dengan aneka buah dan sayur segar yang mereka tawarkan, kami selalu memiliki menu yang sehat dan nikmat setiap hari. Terima kasih AgroBlitar, telah mengubah cara kami melihat makanan sehat.', 'Yes', 1576496271, 2, 1690010871, 1);
...
CREATE TABLE `themes` (
  ...
  `theme_name` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `theme_folder` varchar(50) COLLATE latin1_general_ci NOT NULL,
  `theme_author` varchar(50) COLLATE latin1_general_ci NOT NULL,
  `is_active` enum('true','false') COLLATE latin1_general_ci NOT NULL DEFAULT 'false'
...
(1, 'Vegefoods', 'vegefoods', 'Nokencode', 'true');
...
CREATE TABLE `users` (
  ...
  `user_type` enum('super_user','administrator','user','customer') DEFAULT NULL,
...
(1, 'admin', '$2y$10$fetknyRWIpyGMC5NhLh5OOFsJM39k3r5LY.RJp6vCFjvnjpBh5992', 'KSU Agro Tani', '081222333444', 'https://argotani.sejahtra.com', '-', NULL, 'super_user', NULL, NULL, 1690014850, '::1', 1, 0, 1556509343, 1661633811, NULL, 1, 1, NULL),
...
(4, '12345', '$2y$10$HtJUGsRA5.mIWZp.NIvbxOz.0QtUyn9J.rUhB21ex3hnD8HUQy91.', 'Muhammad Aziz', '081333444555', '', '', NULL, 'user', NULL, NULL, 1578937961, '::1', 1, 0, 1575105916, 1661724261, NULL, 1, 1, NULL),
...
(10, 'admin', '$2y$10$.mrQI0PYoOGI57DaJkBfNeVyINyYu29rhKSAbNqr5eMVFeb1J4j26', 'admin', '083846782100', '', '', NULL, 'administrator', NULL, NULL, NULL, NULL, 1, 0, 1690010924, NULL, NULL, 1, NULL, NULL);
...
(3, 6, 'Eka Saputra', '082248577297', '', '', '', '', 'Jalur 5 SP 1 Kampung Waraitama', 1576432669, 6, 0, 0),
(4, 2, 'Eka Saputra', '081111222333444', '34', '3404', 'Merdeka', '12345', 'Jl. Pejuang Merdeka Barat', 1577456666, 2, 1661723781, 4),
...
--
ALTER TABLE `detail_order`
  MODIFY `iddetail_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `pembayaran`
  MODIFY `idpembayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `product`
  MODIFY `idproduct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `user_profile`
  MODIFY `idUser_profile` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
