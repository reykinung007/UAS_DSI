        ...
        <div class="row">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Welcome to KSU Agro Blitar Catalog Website</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    <p>Agro Blitar adalah platform perdagangan online yang menyediakan layanan jual beli buah-buahan dan sayur-sayuran segar dari berbagai daerah di Indonesia, dengan fokus utama pada produk-produk pertanian yang berasal dari kota Blitar dan sekitarnya. Kami berkomitmen untuk menyediakan kualitas terbaik dengan harga yang bersaing, serta memudahkan para petani dan pembeli untuk bertransaksi secara mudah, aman, dan efisien.</p>
                    <p>Dengan kesederhanaan dan kemudahan sebagai prioritas utama, Agro Blitar bertujuan untuk menjadi portal perdagangan pertanian yang terpercaya dan memberikan kepuasan bagi para pelanggan dan petani. Bergabunglah dengan kami sekarang untuk menikmati manfaat berbelanja buah dan sayur-sayuran segar secara online dengan Agro Blitar!</p>
    ...
    <div class="container">
        <div class="row block-9">
            ...
            <div class="col-md-12 d-flex" style="height:400px;">
                ...
                var latitude = -8.127928;
                var longitude = 112.168313;
                ...
                <script async defer
                    src=https://goo.gl/maps/moRLpPYNssVz5byg9<?=settings('general','google_map_api_key');?>&callback=initMap">
                </script>
            </div>
        </div>
    </div>
